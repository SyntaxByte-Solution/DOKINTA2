...
import UserImage from "../../assets/images/female.png";
...
const Navbar = () => {
  ...
  useEffect(() => {
    const getAdminIn = typeof window !== "undefined" && sessionStorage?.getItem("admin_");

    if (getAdminIn) {
      const adminDataFromStorage = JSON.parse(getAdminIn);
      ...
      <div className="navBar">
        <div className="innerNavbar betBox">
          ...
          <div className="leftNav d-flex">
            ...
            ></i>
            <a className="ms-4 text-white cursor">
              <svg
          ...
          <div className="rightNav">
            <div className="adminProfile betBox  cursor-pointer ">
              <button
                ...
                // onClick={() => handleNotify(adminData?._id)}
              ...
              <Link href="/adminProfile" style={{ backgroundColor: "inherit" }}>
                <div className="adminPic m20-right">
                  {adminData?.image && adminData?.image.length > 0 && (
                    <img
                      src={adminData?.image || ""}
                      alt="Image"
                      width={50}
