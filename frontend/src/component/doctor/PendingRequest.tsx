...
import {doctorActionAccepted, doctorActionDeclined } from "@/store/doctorSlice";
      ...
      Cell: ({ row }) => (
        <span>
          <button
            ...
            onClick={() =>
              dispatch(doctorActionAccepted(row?._id))
            }
          >
            <svg
              width="24"
      ...
      Cell: ({ row }) => (
        <span>
          <button
            ...
            onClick={() =>
              dispatch(doctorActionDeclined(row?._id))
            }
          >
            <svg
              width="24"
