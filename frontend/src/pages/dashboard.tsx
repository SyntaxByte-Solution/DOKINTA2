        ...
        <div className="row">
          <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-3">
            <DashBox
              ...
              amount={dashboard?.dashboardData?.users}
          ...
          <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-3">
            <DashBox
              ...
              amount={dashboard?.dashboardData?.appointments}
            //   onClick={() => navigate("/admin/bookingTable")}
            />
          </div>
          <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-3">
            <DashBox
              ...
              dashSVG={
                <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <mask id="mask0_100_75959" mask-type="luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="42" height="42">
                      <path d="M40.9999 41V1.00012H1V41H40.9999Z" fill="white" stroke="white" stroke-width="2" />
                    </mask>
                    <g mask="url(#mask0_100_75959)">
                      <path d="M29.3242 5.30038C28.3765 4.03671 27.1475 3.01105 25.7347 2.30465C24.3219 1.59824 22.764 1.23048 21.1844 1.23049H20.8154C19.2358 1.23048 17.6779 1.59824 16.2651 2.30465C14.8523 3.01106 13.6234 4.03671 12.6757 5.30038L12.6754 5.3007C12.0904 6.08072 11.7742 7.02939 11.7742 8.00436V13.0921C11.7742 18.1874 15.9047 22.3179 21 22.3179C26.0952 22.3179 30.2257 18.1874 30.2257 13.0921V8.00436C30.2257 7.02937 29.9095 6.08069 29.3245 5.3007L29.3242 5.30038Z" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M11.7742 11.7742H11.7743C12.6181 11.7741 13.4273 11.439 14.024 10.8424L15.7281 9.13827H15.7282C17.365 9.95672 19.1699 10.3828 21 10.3828C22.83 10.3828 24.6349 9.95672 26.2717 9.13827H26.2718L27.9759 10.8424C28.5726 11.439 29.3818 11.7741 30.2256 11.7742H30.2257" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M40.7694 40.7695L37.9954 32.4475C37.6356 31.3679 37.0023 30.3999 36.1572 29.6378C35.3121 28.8757 34.2841 28.3453 33.1733 28.0984L24.9538 26.2719L20.9999 32.8617L17.046 26.2719L8.82662 28.0984C7.71575 28.3453 6.68774 28.8757 5.84268 29.6378C4.99763 30.3999 4.36432 31.3679 4.00443 32.4475L1.23047 40.7695" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M17.046 26.272V21.6335" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M24.9539 26.272V21.6335" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M27.5898 40.7695H26.2719V36.8156C26.2718 36.2964 26.3741 35.7823 26.5728 35.3026C26.7715 34.8229 27.0628 34.387 27.43 34.0199C27.7971 33.6527 28.233 33.3614 28.7127 33.1627C29.1924 32.964 29.7065 32.8617 30.2257 32.8617C32.4094 32.8617 34.1796 34.632 34.1796 36.8156V40.7695H32.8617" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M30.2257 31.5437V27.4434" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M11.7742 35.4976C10.3194 35.4976 9.13831 36.6787 9.13831 38.1335C9.13831 39.5884 10.3194 40.7695 11.7742 40.7695C13.229 40.7695 14.4101 39.5884 14.4101 38.1335C14.4101 36.6787 13.229 35.4976 11.7742 35.4976ZM11.7742 35.4976V27.4433" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                  </g>
                  <defs>
              ...
              amount={dashboard?.dashboardData?.doctors}
          ...
          <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-3">
            <DashBox
              ...
              amount={dashboard?.dashboardData?.earning}

            //   amount={
            //     (counts?.commission ? counts?.commission?.toFixed(2) : 0) +
            //     (setting?.currencySymbol ? " " + setting?.currencySymbol : "")
            //   }
            //   onClick={() => navigate("/admin/staffEarning")}
            />
          </div>
          <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-3">
            <DashBox
              ...
              amount={dashboard?.dashboardData?.revenue}

            //   amount={
            //     (counts?.revenue ? counts?.revenue?.toFixed(2) : 0) +
            //     (setting?.currencySymbol ? " " + setting?.currencySymbol : "")
            //   }
            //   onClick={() => navigate("/admin/monthlyReport")}
            />
          </div>
        </div>
      </div>
