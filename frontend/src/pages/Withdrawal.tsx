...
import { getWithdrawalRequest, withdrawRequestDeclineUpdate, withdrawRequestPayUpdate } from '@/store/withdrawalSlice';
...
export default function Withdrawal() {
  ...
  console.log('withdrawal?.withDrawal?.status', withdrawal?.withDrawal)

  const dispatch = useAppDispatch()

  console.log('witdrawal', withdrawal)
  console.log('status', status)

  useEffect(() => {
    dispatch(getWithdrawalRequest(status))
  }, [dispatch, status])
